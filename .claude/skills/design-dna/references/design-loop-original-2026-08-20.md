# Original: design-loop SKILL.md (Jack Roberts)

> **Quelle:** Notion-Seite „The Design Loop: Free Guide"
> (app.notion.com/p/The-Design-Loop-Free-Guide-3b8e8d6bd13781ff8bf2fc06fd5d0aac,
> verlinkt aus Jacks freier Skool-Community „AI Automation Vault"),
> extrahiert 20.08.2026 aus dem eingebetteten Code-Block, VERBATIM.
> Der Guide nennt als Ursprung der Methode den **„Gauntlet Loop" von
> Matt Shumer** (Original-Prompt: github.com/mshumer/Claude-of-Duty).
> Interne Referenz-Kopie für den Abgleich — keine Weiterveröffentlichung.
> Unsere angepasste Fassung ist die SKILL.md dieses Bausteins.
...
**Begleitwissen von der Guide-Seite (nicht Teil der SKILL.md):**
Kritiker-Modell-Zuordnung: Brief-Kritiker → Sonnet (einfaches Urteil) ·
System-Kritiker → Haiku (mechanische Prüfung) · **Craft-Kritiker →
stärkstes verfügbares Modell, NIE heruntergestuft** („a cheap craft
critic approves everything and the loop dies on round one"). Kostenbild
(extremes Ende, öffentlich berichteter Lauf): 19 h · 1,7 Mrd. Tokens ·
137 Agenten · ~1.200 $ — deshalb: nur fürs Hero-Asset, 3–4 Werkstücke
statt Runden deckeln, der Mensch ist die Bremse. Kernsatz: „A critic
that shares memory with the builder is grading its own homework."
