...
| **CC** | *(bewusst leer — CC ist die Entscheidung des Users, nicht vorbelegt)* |
| **Absender/Versand** | **Der User versendet.** Diese Session versendet nicht und hat kein Postfach angefasst |
| **Sprache** | Deutsch (Sitz DE) |
| **Erstellt** | Session R07-D, 10.08.2026, Repo-Messstand `0ea39bb` |

**Anlass:** Offener Punkt 1 aus `fund/wettbewerbsbild.md` § B9.4 (seit R5):
Ist ein Beherbergungsbetrieb unter Ziffer 3.1.1 der DKU-Richtlinie
...
entscheidet das Datum des Antragseingangs.

### Kernfragen mit Quellverweis
...
- **⚠️ Versand-Vorbedingung (F-7):** Firmierung noch nicht belastbar. Die
  Platzhalter sind **sprechend** und vor dem Versand zu ersetzen.

---

## Betreff

> Auslegungsfragen zur DKU-Richtlinie, Modul Beratung: Antragsberechtigung und Abgrenzung des Beratungsgegenstands
...
>
> wir bauen derzeit ein Beratungsangebot für kleine Beherbergungsbetriebe
> auf und prüfen, für welche Vorhaben unserer künftigen Kunden das Modul
> Beratung der DKU-Richtlinie in Betracht kommt. Wir beziehen uns auf die
...
> zählt anschließend nicht antragsberechtigte Bereiche auf. Beherbergung
> und Gastgewerbe sind dort nicht genannt. Verstehen wir richtig, dass
...
> Betriebskosten gehören, ausdrücklich einschließlich Werbung; Ihre
> Negativliste nennt zusätzlich gängige Online-Marketing-Maßnahmen und
> Website-Kosten zur reinen Unternehmens- oder Produktdarstellung ohne
> Verknüpfung mit den betrieblichen Abläufen. Ihre Positivliste nennt
> umgekehrt die Einführung neuer digitaler Vertriebskanäle sowie die
> Einführung von CRM- und CMS-Systemen. Ein typisches Vorhaben bei uns
> liegt zwischen diesen Polen: Analyse der digitalen Gästeprozesse eines
> Hotels von der Anfrage bis nach der Abreise, Konzeption einer eigenen
> digitalen Buchungs- und Kommunikationsstrecke und ihrer Anbindung an das
> Property-Management-System und die Gästedatenhaltung, mit dem Ziel, den
> Anteil der Direktbuchungen gegenüber Vermittlungsportalen zu erhöhen.
> Wo ziehen Sie hier die Grenze? Ist die von Ihnen genannte Verknüpfung mit
> den betrieblichen Abläufen das maßgebliche Kriterium, und genügt sie,
...
## Nach dem Versand (Pflicht-Nacharbeit)

In einem kleinen, eigenen Commit:

1. Status auf **VERSENDET** setzen — **nur mit Postfach-Beleg**
   (Gesendet-Ordner), nicht auf Zuruf.
2. Versanddatum und Versandkanal eintragen; der Kanal ist selbst
   belegpflichtig.
3. Den tatsächlich versendeten Text gegen diesen Entwurf lesen. Streicht
   der User Absätze, gilt der Gesendet-Body, nicht dieser Entwurf.
4. **Welche Adresse angeschrieben wurde, hier festhalten** — die zweite
   Adresse ist für einen späteren Nachfass reserviert.
5. „Warten auf Antwort" vermerken. **Zielort des Rücklaufs:**
   `handel/foerderarchitektur-beraterrolle.md` Abschnitt 4, zusätzlich
   Vermerk an `fund/wettbewerbsbild.md` § B9.4 über die Leitsession.
6. Antwortverhalten protokollieren. Es ist ein Auswahlkriterium und gilt
   für alle angefragten Stellen gleichermaßen.
